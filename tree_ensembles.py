...
# utilizing a heart failure prediction dataset

df = pd.read_csv('Advanced_Learning_Algorithms\data\heart.csv')
print(df.head())
...
#replacing the columns with one hot encodings
...
#building the models
#setting up thresholds to stop splitting
